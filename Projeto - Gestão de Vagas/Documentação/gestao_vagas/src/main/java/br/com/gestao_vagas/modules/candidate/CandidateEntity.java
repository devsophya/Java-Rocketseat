...
public class CandidateEntity {
    ...
    @Schema(example = "Gustavo Vieira", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;
    ...
    @Schema(example = "gustavo@gmail.com", requiredMode = RequiredMode.REQUIRED, description = "Email do candidato")
